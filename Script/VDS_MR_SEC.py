...
DATASET = 'VDS_VMR_VSEC'

ANALOG_LABELS = ['VDS_A', 'VDS_B', 'V_MR', 'V_SEC']
...
try:
    ...
    for swp in SWEEPS:
        ...
        for var in swp.Points:
            ...
            vdsa = MSO7034B.query_ascii_values(':MEASure:VPP? %s' % ('CHANNEL1')) [0]
            vdsb = MSO7034B.query_ascii_values(':MEASure:VPP? %s' % ('CHANNEL2')) [0]
            ...
            vsecpp = MSO7034B.query_ascii_values(':MEASure:VPP? %s' % ('CHANNEL4')) [0]
