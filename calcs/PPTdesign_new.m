...
RL_phase, Rload_tot, LMR, CMR, Cp_total, Cpext, LF, Ls2, Cs2 %[output:1d93e6e0] %[output:48341e1a] %[output:657f6a49] %[output:1406963f] %[output:25e4598c] %[output:0558a9d8] %[output:618b75d6] %[output:81803653] %[output:89052846]
...
%---
%[output:0558a9d8]
%   data: {"dataType":"textualVariable","outputData":{"name":"Cpext","value":"    292.770001687647e-012\n"}}
%---
%[output:618b75d6]
